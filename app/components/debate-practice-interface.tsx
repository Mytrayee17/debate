...
interface DebatePracticeInterfaceProps {
  topic: DebateTopic;
...
export function DebatePracticeInterface({ topic, userRole, onRoleChange, onBack }: DebatePracticeInterfaceProps) {
      ...
      if ("webkitSpeechRecognition" in window || "SpeechRecognition" in window) {
        ...
        recognitionRef.current.onresult = (event: any) => {
          ...
          if (finalTranscript.trim()) {
            // Instead of sending immediately, set as userInput for review/edit
  ...
  const handlePhaseComplete = () => {
    if (debatePhase === "prep") {
      ...
      setTimeRemaining(topic.timeLimit || 600)
  ...
  const generateAiResponse = useCallback(
    ...
    [topic, currentRound, aiVoiceEnabled, maxRounds],
  )

  const generateContextualResponse = async (userInput: string, round: number): Promise<string> => {
    if (!topic) return "I need more information to respond."
  ...
  const handleTextSubmit = () => {
    ...
    setUserInput("")
    setCurrentTranscript("") // Clear transcript on send
  ...
  const startDebateWithAI = () => {
    const aiOpening = `Welcome to this debate on "${topic?.motion}". I'll be arguing for the ${userRole === "government" ? "opposition" : "government"} side. I believe there are significant issues with your position. Please present your opening argument, and I'll respond accordingly.`
  ...
  const startTopic = (topic: DebateTopic) => {
    // This function is no longer needed as topic is passed as a prop
          ...
          <CardHeader>
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
              <div className="space-y-2">
                ...
                <CardTitle className="text-xl lg:text-2xl">{topic.title}</CardTitle>
                <p className="text-white/90 text-sm">"{topic.motion}"</p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
                ...
                <div className="text-center">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => onRoleChange(userRole === "government" ? "opposition" : "government")}
            ...
            <Card className="xl:col-span-2">
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-blue-800 italic">"{topic.motion}"</p>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="space-y-2">
                      {topic.keyArguments[userRole].map((argument, index) => (
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {topic.keyArguments[userRole === "government" ? "opposition" : "government"]
                        .slice(0, 2)
                        .map((argument, index) => (
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        <span>Time Used</span>
                        <span>
                          {Math.round(((topic.timeLimit - timeRemaining) / topic.timeLimit) * 100)}%
                        </span>
                      </div>
                      <Progress
                        value={((topic.timeLimit - timeRemaining) / topic.timeLimit) * 100}
                        className="h-2"
                      />
                    </div>
                  </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">You've completed your debate on "{topic.motion}"</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-6 bg-yellow-50 rounded-lg border border-yellow-200">
                  <div className="text-3xl font-bold text-yellow-600">
                    {formatTime(topic.timeLimit - timeRemaining)}
                  </div>
